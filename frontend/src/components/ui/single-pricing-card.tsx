...
export function Pricing() {
  return (
    <section className="relative overflow-hidden py-12 pb-8">
        ...
        <div className="relative">
          ...
          <div
            className={cn(
              ...
              'bg-[linear-gradient(to_right,hsl(var(--border)/0.4)_1px,transparent_1px),linear-gradient(to_bottom,hsl(var(--border)/0.4)_1px,transparent_1px)]',
              'bg-[size:32px_32px]',
          ...
          >
            {/* Monthly / Yearly split card */}
            <div className="relative grid bg-background border md:grid-cols-2 p-4">
              {/* Corner plus icons */}
              <PlusIcon className="absolute -top-3 -left-3 size-5 text-foreground" />
